        ...
        <div class="col-lg-8 col-12">
            ...
            <div class="border-bottom pb-4">
                <div class="row">
                    ...
                    <div class="col-12 border shadow caja" v-for="categoryUser in categoriesUser" :key="categoryUser.id">
                        <h2 class="font-weight-bold">{{ categoryUser.category.label }}</h2>
                        <h3 class="font-weight-bold">${{ categoryUser.price }}</h3>
                        <p class="text-muted"> {{ categoryUser.description }}</p>
