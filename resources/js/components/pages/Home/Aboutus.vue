                ...
                <div class="col-12">
                    <div class="section-title text-center mb-4 pb-2">
                        ...
                        <p class="text-muted para-desc mx-auto mb-0">
                            <span class="text-primary font-weight-bold">Búsqueda selectiva → Toma de contacto → Contratación</span>
                            <div>
                                <span class="text-primary font-weight-bold">Búsqueda selectiva:</span>
                            ...
                            <div>
                                <span class="text-primary font-weight-bold">Toma de contacto:</span>
                                usa nuestro chat online como primera toma de contacto y así poder llegar a un acuerdo con la persona a contratar.
                            </div>
                            <div>
                                <span class="text-primary font-weight-bold">Contratación:</span>
