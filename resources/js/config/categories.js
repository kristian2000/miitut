...
const categories = [
    {
        ...
        desc: {
            ...
            text: 'Encuentra de manera fácil e intuitiva mediante el uso de nuestros filtros, a la persona adecuada que se ajuste mejor a tus necesidades. Ayúdate de sus valoraciones y experiencia laboral. La mejor atención domiciliaria a tu disposición, infórmate de sus tarifas, contacta cómodamente y sin ningún tipo de compromiso.'
        },
        homeSelected: true,
...

    {
        ...
        desc: {
            title: '¿Necesitas ayuda para limpiar tu casa, local o empresa? ',
            text: 'Aquí encontrarás el servicio de limpieza más rápido y eficiente, contrátalo desde casa en un instante. Ayúdate de nuestros filtros para dar con los profesionales más cualificados y que se ajusten perfectamente a lo que buscas. Contacte con la limpiadora ideal y disfrute de sus servicios.'
        },
        homeSelected: true,
    ...
    },
    {
        ...
        desc: {
            ...
            text: 'Sabemos lo importante que es nuestro bienestar, por ello con el sistema de búsqueda de Miitut tendrás a tu alcance multitud de profesionales dispuestos a ofrecerte sus servicios. Selecciona servicio, contacta con el profesional o directamente reserva tu cita.'
        },
    ...
    },
    {
        ...
        pathImgHeader: "/images/headersCategories/garder.jpg",
        imagen: "/images/categories/gardens.jpg",
        desc: {
    ...
    },
    {
        ...
        desc: {
            ...
            text: 'Utiliza nuestro buscador para dar con el profesional adecuado para tu cuidado estético facial y corporal, desde cortar el cabello, peinados, tintes, manicuras, maquillajes, depilación y mucho más. Ayúdate de nuestros filtros, selecciona el servicio que necesites, elige profesional y pide tu cita. Recuerda que disponemos de pago seguro.'
        },
    ...
    },
    {
        ...
        label: 'Parasanitaria',
        icon: '/assets/icon_services/parasanitary.svg',
