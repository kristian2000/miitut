            ...
            <div class="row">
                <div class="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                    ...
                    <ul class="list-unstyled social-icon social mb-0 mt-4">
                        ...
                        <li class="list-inline-item ml-1"><a href="https://www.instagram.com/miitut.es/?hl=es" class="rounded" target="_blank">
                ...
                <div class="col-lg-4 col-md-4 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0">
                    ...
                    <ul class="list-unstyled footer-list mt-4">
                        ...
                        <li>
                            <router-link to="/support" class="text-foot"><i class="mdi mdi-chevron-right mr-1"></i> Soporte</router-link>
                        </li>
