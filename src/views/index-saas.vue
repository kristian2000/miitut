            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center mt-0 mt-md-5 pt-0 pt-md-5">
                    <div class="title-heading margin-top-100">
                        ...
                        <div class="mt-4 pt-2">
                            <a v-scroll-to="'#about'" class="btn btn-primary">Start Free Trial <i class="mdi mdi-chevron-right"></i></a>
                        </div>
                    </div>
        ...
        <div class="container mt-100 mt-60">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-6">
                    <img src="images/saas/1.png" class="img-fluid shadow rounded" alt="">
                </div>
                <!--end col-->
        ...
        <div class="container mt-100 mt-60">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-12 mt-4">
                    <carousel id="customer-testi" :per-page="3" dir="ltr" :autoplay="true">
                        <Slide>
